...
`skip meta sbom create` command and presents the bundled software dependencies as a
...
Use the `skip meta sbom create` command to produce the SPDX files and place them
